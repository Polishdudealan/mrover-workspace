Code for the ZED-F9P GNSS Module UBlox GPS Receiver
===================================================
### About
...
### NMEA Sentences
NMEA Sentences, or National Marine Electronics Association Sentences, are data structures that provide satellite data to GPS receivers. There are different types of sentences with different data, configurations, and datatypes. See resources below for more info.
